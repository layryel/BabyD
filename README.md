...
<br><br>
  ...
  Layara Miranda
> "Durante a execução do projeto BabyD, desempenhei funções essenciais que contribuíram significativamente para o êxito da iniciativa. Minha participação abrangeu diversas fases, desde a pesquisa teórica até a implementação prática.  
Na elaboração de conteúdo, redigi uma monografia que abordou a temática principal do projeto, documentando suas etapas e a aplicação das ferramentas, proporcionando uma base conceitual robusta e explicações detalhadas de seu uso. Também desenvolvi um artigo científico que explorou aspectos inovadores e tecnológicos do projeto, apresentado em um congresso (Engetec). Além disso, realizei um levantamento detalhado dos requisitos do projeto com base na UML, assegurando uma estrutura sólida para a criação de diagramas, e elaborei documentação dos casos de uso, definindo os fluxos de interação do sistema.
Na área de modelagem e desenvolvimento, criei o diagrama de caso de uso para representar e especificar os requisitos funcionais do projeto, contribuí para a lógica dos diagramas, garantindo coerência e funcionalidade por meio de revisões, e desenvolvi parte do site do projeto, incluindo a criação de textos, imagens e estilização visual.  
No âmbito apresentação e divulgação, produzi slides para diferentes momentos do projeto (pré-projeto, referencial teórico, intermediário online, PITCH final e feira tecnológica) e elaborei roteiros detalhados para cada apresentação, garantindo clareza e consistência na comunicação. 
Essa experiência enriquecedora possibilitou o desenvolvimento de habilidades técnicas, de pesquisa e de comunicação, além de promover o trabalho em equipe. Apesar dos desafios enfrentados, conseguimos superá-los graças ao nosso esforço e ao apoio recebido, culminando no sucesso do Projeto BabyD."
  
Mariana Ocireu
> "Durante o desenvolvimento do Projeto BabyD, desempenhei um papel fundamental e multifacetado, contribuindo significativamente para o sucesso da iniciativa. Minha participação abrangeu diversas etapas, desde o design e planejamento até a implementação e desenvolvimento.
No âmbito do design, criei wireframes de baixa fidelidade para o aplicativo, estabelecendo uma base sólida para o design e funcionalidades. Posteriormente, desenvolvi wireframes de alta fidelidade para o aplicativo e site, refinando a estrutura, layout e experiência do usuário. Esses wireframes garantiram coerência visual e funcional.
Na etapa de modelagem, desenvolvi diagramas de sequência e atividade, mapeando fluxos de interação e processos, garantindo uma base sólida para a programação. Além disso, expliquei detalhadamente esses diagramas, facilitando a comunicação entre a equipe e stakeholders.
No desenvolvimento, programei o site e o aplicativo, abrangendo tanto o front-end quanto o back-end. Integrei funcionalidades e requisitos definidos, garantindo uma solução robusta e eficiente. Adicionei a biblioteca de reconhecimento facial ao aplicativo, proporcionando uma solução inovadora para a segurança.
Paralelamente, realizei uma pesquisa aprofundada para o referencial teórico, proporcionando uma base teórica sólida para o desenvolvimento. Essa pesquisa permitiu uma compreensão profunda dos conceitos e tecnologias envolvidas.
Foi gratificante ver os resultados positivos que alcançamos com o projeto, com certeza será um projeto de muito sucesso. Além disso, foi uma experiência enriquecedora que consolidou minha capacidade de trabalhar em equipe, gerenciar projetos complexos e desenvolver soluções inovadoras."
